Marbles.View = class View
  ...
  @templates: window.HoganTemplates
  @getTemplate: (template_path) ->
    throw new Error("Marbles.View.templates is not defined. Expected an object conatining compiled hogan (mustache) templates.") unless @templates
